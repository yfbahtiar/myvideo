...
INSERT INTO `categories` (`id`, `judul`) VALUES
(1, 'Pendidikan'),
(2, 'Hiburan');
...
--
-- Table structure for table `tmp_viewers`
--

CREATE TABLE `tmp_viewers` (
  `id` int(11) NOT NULL,
...
(1, 'admin', 'Admin', '$2y$10$vqr6U/eFVEpSo3lIrJNbqeY5.irpglmLAE/NHs7mjsorZ1yL8lM1i', 1),
(2, 'user', 'User', '$2y$10$zS9PUGICNNJtPV/U4KfZ9e5ctJDR5uxjWwSc4yW5xtHUBxuRyfbzS', 2);
...
--
-- Indexes for table `tmp_viewers`
--
ALTER TABLE `tmp_viewers`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tmp_viewers`
--
ALTER TABLE `tmp_viewers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
